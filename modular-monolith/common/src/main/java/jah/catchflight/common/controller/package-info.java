/**
 * The {@code jah.catchflight.common.controller} package contains controller classes
 * responsible for handling HTTP requests and coordinating the flow of data
